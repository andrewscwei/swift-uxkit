...
public class URLVideoView: UIView, StateMachineDelegate {
  ...
  /// A weak reference to the aspect ratio constraint of this view. This is necessary in order for the view to properly resize itself based on the actual dimension of the loaded video.
  ...
  /// Updates the aspect ratio constraint of this view. The constraint is based on the size of the current displayed video, and automatically changes the view's height according to the aspect ratio of the video relative to the view's width.
