...
extension NSAttributedString {
  ...
  /// - Returns: The height of the attributed string if it were constrained within the provided width.
  ...
  /// - Returns: The width of the attributed string if it were constrained within the provided height.
