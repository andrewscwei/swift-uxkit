...
extension UIScrollView {
  ...
  /// The content offset of the scroll view at its minimum scroll position, with insets taken into
  /// account.
  ...
  /// The content offset of the scroll view at its maximum scroll position, with insets taken into
  /// account.
