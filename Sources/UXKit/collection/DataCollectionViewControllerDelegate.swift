...
public protocol DataCollectionViewControllerDelegate: AnyObject {
  ...
  ///
  /// - Parameters:
  ///   - collectionViewController: The `DataCollectionViewController` instance that invoked this method.
  ...
  /// Method invoked when applying default item selection. Return the datum (singular) or data (plural) to be selected by default. This selection is applied whenever the collection refreshes and only if there are no preexisting selections at the time of refresh.
  ///
  /// - Parameters:
  ///   - collectionViewController: The `DataCollectionViewController` instance that invoked this method.
  ...
  ///
  /// - Parameters:
  ///   - collectionViewController: The `DataCollectionViewController` instance that invoked th is method.
