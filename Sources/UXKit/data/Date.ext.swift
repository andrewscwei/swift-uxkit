...
extension Date {
  ...
  ///   1. `LTXT_TIME_1_YEAR` and `LTXT_TIME_N_YEARS`: String representations of 1 year and N years respectively, where N is an integer.
  ///   2. `LTXT_TIME_1_DAY` and `LTXT_TIME_N_DAYS`: String representations of 1 day and N days respectively, where N is an integer.
  ///   3. `LTXT_TIME_1_HOUR` and `LTXT_TIME_N_HOURS`: String representations of 1 hour and N hours respectively, where N is an integer.
  ///   4. `LTXT_TIME_1_MINUTE` and `LTXT_TIME_N_MINUTES`: String representations of 1 minute and N minutes respectively, where N is an integer.
