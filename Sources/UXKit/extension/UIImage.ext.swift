...
extension UIImage {
  ...
  /// Resizes the shorter edge of the image to the specified length while maintaining the original aspect ratio.
  ///
  /// - Parameters:
  ...
  /// Resizes the longer edge of the image to the specified length while maintaining the original aspect ratio.
  ///
  /// - Parameters:
  ///   - image: The image to resize.
  ///   - min: The length to resize the target edge to.
  ...
  /// Fits an image in the specified size while maintaining aspect ratio. Unused space will be cropped, so the size of the image may be smaller than the fitted size.
  ///
  /// - Parameters:
  ///   - image: The image to use.
