...
/// An object that conforms to this protocol will automatically have access a `DisplayLinkDelegate` instance. The object must manually invoke `start` on the `DisplayLinkDelegate` before it can be used (and subsequently invoking `stop` for garbage collection.
